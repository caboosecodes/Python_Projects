...
# import the other modules so we can have access to them
import phonebook_main
import phonebook_func


# self is the key to get access to the class
def load_gui(self):
    '''
        Define the default tkinter widgets and their initial configuration
        and place them using the grid geometry. Grid offers the best
        control for placing the widgets
    '''

    # labels
    # Label() is the tkinter's class for a label
    # once you create a instantiation of Label() you need to give it a class name, in this case its "self.lbl_fname"
    # to place it use grid
    ...
    # event listener bind, if a user clicks on item in the list execute lambda
